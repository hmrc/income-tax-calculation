...
object GetCalculationListHttpParserLegacy extends DESParser {
  type GetCalculationListResponseLegacy = Either[DesErrorModel, Seq[GetCalculationListModelLegacy]]
