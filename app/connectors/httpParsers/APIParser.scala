...
trait APIParser {
  ...
  def badSuccessJsonFromAPI[Response](responseAsString: String, validationErrors: collection.Seq[(JsPath, collection.Seq[JsonValidationError])] ): Either[ErrorModel, Response] = {
